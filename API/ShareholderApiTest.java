...
public class ShareholderApiTest {
    ...
    private static final String BASE_URL = "https://5chfmeq9qw.us-east-1.awsapprunner.com/v1/shareholder-meeting";
    ...
    public void testServerError() {
        given()
            .baseUri("https://invalid-url.com/v1/shareholder-meeting")
            .header("Authorization", "Bearer " + TOKEN)
        .when()
            .get()
        .then()
